...
export default function PastDahaItem({postCreatorName, itemNeeded, sizeNeeded, colorNeeded, occasionNeeded, dateNeededBy, dateReturnedBy, details}){
    ...
    return(
        ...
        <Pressable style={styles.container}>
            ...
            <Pressable style={styles.postInfoView} onPress={() => {navigation.navigate("pre-review", { origin: [postCreatorName, itemNeeded, sizeNeeded, colorNeeded, occasionNeeded, dateNeededBy, dateReturnedBy, details], makingNewPost: false })}}>
